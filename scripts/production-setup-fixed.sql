-- Complete Supabase setup for production with policy cleanup
...
DO $$ 
BEGIN
  -- Drop company_accounts policies
  BEGIN
    DROP POLICY IF EXISTS "Users can view own company" ON public.company_accounts;
    DROP POLICY IF EXISTS "Users can update own company" ON public.company_accounts;
  EXCEPTION
  ...
  BEGIN
    DROP POLICY IF EXISTS "Users can view company buildings" ON public.buildings;
    DROP POLICY IF EXISTS "Users can manage company buildings" ON public.buildings;
  EXCEPTION
    WHEN OTHERS THEN NULL;
  END;
  ...
  BEGIN
    ...
    DROP POLICY IF EXISTS "Users can manage company units" ON public.units;
  EXCEPTION
    WHEN OTHERS THEN NULL;
  END;
  ...
  BEGIN
    DROP POLICY IF EXISTS "Users can view company tenants" ON public.tenants;
    DROP POLICY IF EXISTS "Users can manage company tenants" ON public.tenants;
  EXCEPTION
    WHEN OTHERS THEN NULL;
  END;
  
  -- Drop notices policies
  BEGIN
    DROP POLICY IF EXISTS "Users can view company notices" ON public.notices;
    DROP POLICY IF EXISTS "Users can manage company notices" ON public.notices;
  EXCEPTION
    WHEN OTHERS THEN NULL;
  END;
  ...
  BEGIN
    DROP POLICY IF EXISTS "Users can view company inquiries" ON public.inquiries;
    DROP POLICY IF EXISTS "Users can manage company inquiries" ON public.inquiries;
  EXCEPTION
    WHEN OTHERS THEN NULL;
  END;
