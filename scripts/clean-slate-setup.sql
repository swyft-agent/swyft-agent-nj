-- Clean slate setup for new accounts
...
-- Update the create_user_profile function to ensure clean slate
...
-- Update the create_company_account function to ensure clean slate
